...
export default class MessageModal extends Component<IProps, IState> {
            ...
            <Modal
                    ...
                    >
                     <View style={styles.modalContent}>
                        <Text style={{fontWeight: 'bold'}}>You are sending a DM to {this.props.userInfo}</Text>
                        <Button style={styles.fullWidthButton}
                                    ...
                                    onPress={() => {
                                        this.props.functions.closeConfirmModal(true);
                                    } }
                                    loading={false}
                                    disabled={false}
                                    // loadingStyle={}
                         ...
                         <Button style={styles.fullWidthButton}
                                    ...
                                    onPress={() => {
                                        this.props.functions.closeConfirmModal(false);
                                    } }
                                    loading={false}
                                    disabled={false}
                                    // loadingStyle={}
